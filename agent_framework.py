...
class FitbitAgentSystem:
    ...
    def _build_graph(self) -> StateGraph:
        ...
        graph.add_node("browser_agent", ToolNode(tools=self.tools["browser"]))
        graph.add_node("gmail_agent", ToolNode(tools=self.tools["gmail"]))
        graph.add_node("extraction_agent", ToolNode(tools=self.tools["extractor"]))
        graph.add_node("database_agent", ToolNode(tools=self.tools["database"]))
